...
@section('default')
    ...
    <div class="d-flex justify-content-center mt-5">
        <form action="{{route('reg.store')}}" method="post" style="max-width: 450px; width: 450px" class="card shadow-lg p-5">
            @csrf
            <p class="fs-1 text-center p-0 m-0 mb-3 text-info">Join us!</p>
            <div class="mb-3">
                <label for="username" class="form-label">Username</label>
                <input type="text" class="form-control" style="" id="username" value="{{old('name')}}" name="name" placeholder="Miko">
                @error('name')<p class="text-danger-emphasis m-0 p-0">{{$message}}</p>@enderror
            </div>
            <div class="mb-3">
                <label for="password" class="form-label">Password</label>
                <input type="password" class="form-control" style="" id="password" name="password" placeholder="Minimum 8 characters">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" style="" id="conPass" name="password_confirmation" placeholder="Minimum 8 characters">
