...
@section('default')
    ...
    <div class="m-4">
        ...
        <div class="d-flex justify-content-center mt-5">
            <form action="{{route('login.store')}}" method="post" style="max-width: 450px; width: 450px" class="card shadow-lg p-5">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" style="" id="password" name="password" placeholder="Your password">
