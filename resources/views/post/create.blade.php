...
@section('default')
    ...
    <form action="{{route('posts.store')}}" method="post" class="w-50 m-auto text-white p-0">
        ...
        <p class="mt-5 text-white-50">Если что аноним реально работает. Там в бд автором будешь не ты, а аккаунт который я создал и дал имя аноним. Пруфы есть если что, и код открытый. В гитхабе есть.</p>
